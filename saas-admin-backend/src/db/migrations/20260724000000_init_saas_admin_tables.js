exports.up = async function (knex) {
  ...
  await createIfMissing('admin_roles', table => {
  ...
  await createIfMissing('admin_permissions', table => {
    table.increments('id').primary();
  ...
  await createIfMissing('admins', table => {
    table.increments('id').primary();
  ...
  await createIfMissing('refresh_tokens', table => {
  ...
  await createIfMissing('companies', table => {
    table.increments('id').primary();
    table.string('name').notNullable();
  ...
  await createIfMissing('users', table => {
    table.string('id').primary(); // UUID
    table.string('name').notNullable();
    table.string('email').notNullable().unique();
  ...
  await createIfMissing('plans', table => {
    table.increments('id').primary();
    table.string('name').notNullable();
  ...
  await createIfMissing('company_subscriptions', table => {
    table.increments('id').primary();
  ...
  await createIfMissing('coupons', table => {
  ...
  await createIfMissing('coupon_redemptions', table => {
    table.increments('id').primary();
  ...
  await createIfMissing('audit_logs', table => {
    table.increments('id').primary();
