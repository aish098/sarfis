  ...
  return (
    <div className="space-y-6 font-sans pb-20">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="font-display font-extrabold text-[22px] text-slate-900 tracking-tight">Goods Receipts (GRN)</h1>
          <p className="text-[12.5px] text-slate-500 mt-1">Verify vendor shipments, manage warehouse intake quantities, and restock inventory.</p>
        </div>
        <button 
          onClick={() => {
            setGrnForm({
